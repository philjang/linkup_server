...
# from ..membership.models import Circle

# Create your models here.
# Model schema for discussions_api_discussion table
class Discussion(models.Model):
    circle = models.ForeignKey('membership.Circle', on_delete=models.CASCADE, related_name='discussions') # related_name allows access to an array of this model's instances from the related 1:M model's serializer/view
